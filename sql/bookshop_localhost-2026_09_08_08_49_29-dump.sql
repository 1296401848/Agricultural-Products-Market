...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='图书分类表';
...
INSERT INTO `book_category` VALUES (0,'未分类','2026-06-15 16:28:32'),(1,'文学类','2025-12-02 17:32:32'),(2,'科技类','2025-12-02 17:32:32'),(3,'历史类','2025-12-02 17:32:32'),(4,'少儿类','2025-12-02 17:32:32'),(5,'经管类','2025-12-02 17:32:32'),(6,'艺术类','2025-12-02 17:32:32');
...
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='图书信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `book_package`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='图书套餐主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_item` (
  ...
  `item_type` tinyint NOT NULL DEFAULT '1' COMMENT '明细类型 1-普通图书 2-套餐',
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`),
  KEY `fk_item_book` (`book_id`),
  CONSTRAINT `fk_item_book` FOREIGN KEY (`book_id`) REFERENCES `book_info` (`id`),
...
CREATE TABLE `package_book` (
  ...
  `book_id` bigint NOT NULL COMMENT '图书ID',
  `book_num` int NOT NULL DEFAULT '1' COMMENT '套餐内该图书数量',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_package_book` (`package_id`,`book_id`),
  KEY `idx_book_id` (`book_id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='套餐-图书关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shopping_cart` (
  ...
  `quantity` int DEFAULT '1' COMMENT '图书数量',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `package_id` bigint DEFAULT NULL COMMENT '套餐ID，为空代表普通图书',
  `cart_type` tinyint NOT NULL DEFAULT '1' COMMENT '购物项类型 1-普通图书 2-套餐',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-09-08  8:49:30
